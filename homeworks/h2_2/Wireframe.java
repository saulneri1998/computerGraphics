        ...
        public void paintComponent(Graphics g) {
            ...
            if (!focussed) {
                ...
                for ( j = 0; j < edges.length; ++j ) {
                    if (edges[j].type == 0) {
                        double avgY = (vertices[ edges[j].a ].y + vertices[ edges[j].b ].y) / 2;
                        if (avgY < -0.1) {
                            g.setColor(new Color(70, 91, 191));
                        } else if (avgY > 0.1) {
                            g.setColor(new Color(122, 193, 84));
                            // g.setColor(Color.WHITE);
                        } else {
                            g.setColor(new Color(197, 153, 101));
                        }
                    } else if (edges[j].type == 1) {
                        g.setColor(new Color(95, 30, 61));
                    } else if (edges[j].type == 2) {
                        g.setColor(new Color(95, 40, 61));
                    } else if (edges[j].type == 3) {
                        g.setColor(new Color(95, 50, 61));
                    } else if (edges[j].type == 4) {
                        g.setColor(new Color(95, 60, 61));
                    } else if (edges[j].type == 5) {
                        g.setColor(new Color(95, 70, 61));
                    } else if (edges[j].type == 6) {
                        g.setColor(new Color(95, 80, 61));
                    } else if (edges[j].type == 7) {
                        g.setColor(new Color(95, 90, 61));
                    } else if (edges[j].type == 8) {
                        g.setColor(new Color(95, 100, 61));
                    }
